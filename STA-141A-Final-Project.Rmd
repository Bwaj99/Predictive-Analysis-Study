...
# Replace "session1_test.rds" and "session18_test.rds" with actual test file names.=

# test_predictions_1 <- evaluate_final_test_set("session1_test.rds", model, max_neurons)
# test_predictions_18 <- evaluate_final_test_set("session18_test.rds", model, max_neurons)
